...
map.getView().fit([15192789.314202, 4048619.694451, 15678066.133353, 4648463.377513], map.getSize());
...
map.on("rendercomplete", function(evt) {
    if (!attributionComplete) {
        ...
        var asmpAttribution = document.createElement('li');
        asmpAttribution.innerHTML = '<a href="https://animesitemap.github.io/copyright">Anime Site Mapping Project</a> &middot; ';
        ...
        osmAttribution.innerHTML = '<a href="https://www.openstreetmap.org/copyright">© OpenStreetMap contributors</a>';
        attributionList.insertBefore(asmpAttribution, firstLayerAttribution);
